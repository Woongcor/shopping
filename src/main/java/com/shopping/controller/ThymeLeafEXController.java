...
public class ThymeLeafEXController {
    ...
    //http://localhost:8989/thymeleaf/ex01 브라우저에서 해당 주소를 조회하면
    @GetMapping(value = "/ex01")
    public String thymeleafExample01(Model model){  //해당 메소드 실행

        model.addAttribute("data", "타임 리프 1번 째 예시 쀼쀼");
